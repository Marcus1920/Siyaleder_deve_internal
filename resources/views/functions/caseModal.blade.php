...
$("#submitAssociatePoiForm").on("click",function(){
  ...
  $("#submitCreateCaseAgentForm").on("click",function(){
		...
		var dueDate                     = $("#CreateCaseAgentForm #dueDate").val();
		var defaultEntry                = $("#CreateCaseAgentForm #defaultEntry").val();
		...
		//alert(house_holder_id + " " + dueDate + " " + defaultEntry + " " + department + " " + category + " " +  sub_category + " " + sub_sub_category + " " + case_type);
           ...
           if(data == 1)
           {
            ...
            $.ajax({
                  ...
                  if(data[0] !== null)
                  {
                     ...
                     $("#modalCase #case_type").val(data[0].department);
                     $("#modalCase #case_sub_type").val(data[0].category);
