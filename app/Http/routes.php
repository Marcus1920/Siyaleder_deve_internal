...
Route::get('form',function(){
  ...
  Route::post('requestcloser','ReportCController@requestcloser');
	...
	Route::get('calander_shith', 'Students_profile_controller@calander_shith');
	Route::post('caseconfirmation', 'Students_profile_controller@caseconfirmation');
  Route::get('list-SafetyTips','SafetyTipsController@index');
  Route::post('list-SubSafetyTips','SubSafetyTipsController@index');
	...
	Route::post('studentpancak', 'Students_profile_controller@studentpancakbooloing');
